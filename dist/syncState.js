...
exports.initMessageListener = exports.initStateWithPrevTab = exports.withReduxStateSync = exports.createReduxStateSync = exports.createStateSyncMiddleware = void 0;
let lastUuid = 0;
...
const WINDOW_STATE_SYNC_ID = guid(); // export for test
...
exports.createStateSyncMiddleware = createStateSyncMiddleware;

const createReduxStateSync = (appReducer, prepareState = defaultConfig.prepareState) => (state, action) => {
  let initState = state;
...
exports.createReduxStateSync = createReduxStateSync;
const withReduxStateSync = createReduxStateSync;
exports.withReduxStateSync = withReduxStateSync;

const initStateWithPrevTab = ({
  dispatch
}) => {
...
exports.initStateWithPrevTab = initStateWithPrevTab;
...
exports.initMessageListener = initMessageListener;